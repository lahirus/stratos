...
import org.apache.stratos.messaging.event.health.stat.AverageRuestsServingCapabilityEvent;
...
public class AverageRequestsServingCapabilityMessageProcessor  extends MessageProcessor {
    ...
    public boolean process(String type, String message, Object object) {
        if (AverageRuestsServingCapabilityEvent.class.getName().equals(type)) {
            ...
            AverageRuestsServingCapabilityEvent event = (AverageRuestsServingCapabilityEvent) Util.jsonToObject(message, AverageRuestsServingCapabilityEvent.class);
